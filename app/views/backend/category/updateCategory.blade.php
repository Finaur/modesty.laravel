                  ...
                  <div class="panel-body">
                     {{ Form::open(array('url'=>URL::current(), 'method' => 'POST')) }}
                        ...
                        <div class="form-group @if ($errors->has('category_name')) has-error @endif">
                           ...
                           <div class="col-sm-10"> 
                              <input type="text" name="category_name" value="{{$category->category_name}}" class="form-control" placeholder="title news"> 
                              @if ($errors->has('category_name')) <p class="help-block">{{ $errors->first('news_title') }}</p> @endif
                           </div>
                         </div>
