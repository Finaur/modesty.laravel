                  ...
                  <div class="panel-body">
                     {{ Form::open(array('url' =>'news', 'files' => 'true')) }}
                        <div class="form-group @if ($errors->has('news_title')) has-error @endif">
                           ...
                           <div class="col-sm-10"> 
                              <input type="text" name="news_title" class="form-control" placeholder="title news"> 
                        ...
                        <div class="form-group @if ($errors->has('summary_news')) has-error @endif">
                           ...
                           <div class="col-sm-10"> 
                              <textarea name="summary_news" class="form-control"></textarea>
                        ...
                        <div class="form-group @if ($errors->has('content_news')) has-error @endif">
                           ...
                           <div class="col-sm-10"> 
                            <textarea id="content_news" name="content_news" class="ckeditor"></textarea> 
