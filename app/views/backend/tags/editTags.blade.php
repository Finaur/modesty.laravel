            ...
            <div class="col-sm-12">
               <section class="panel panel-default">
                  ...
                  <div class="panel-body">
                    {{ Form::model($tags, array('route' => array('tags.update', $tags->tags_id), 'method' => 'PUT')) }}
                        <div class="form-group @if ($errors->has('tags_name')) has-error @endif">
                           <label class="col-sm-2 control-label">
                              Tags Name
                           </label> 
                           <div class="col-sm-10"> 
                              <input type="text" name="tags_name" class="form-control" placeholder="Tags name" value="{{$tags->tags_name}}"> 
